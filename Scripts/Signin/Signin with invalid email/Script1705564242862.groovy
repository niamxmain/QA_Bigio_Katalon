...
WebUI.setText(findTestObject('Object Repository/Page_Sign In - Ultimate QA/input_useremail'), 'ujiemail')
...
WebUI.verifyElementVisible(findTestObject('Object Repository/Page_Sign In - Ultimate QA/li_Invalid email or password'))
