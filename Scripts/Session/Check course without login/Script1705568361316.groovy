...
WebUI.verifyElementVisible(findTestObject('Page_My Dashboard - Ultimate QA/h2_Welcome back, asep u'))
...
WebUI.click(findTestObject('Object Repository/Page_Ultimate QA/h3_Modern React and NodeJS Development (han_0c4504'))

WebUI.verifyElementVisible(findTestObject('Object Repository/Page_Modern React and NodeJS Development (h_2e3419/h2_Modern React and NodeJS Development (han_0bd4ad'))

WebUI.click(findTestObject('Object Repository/Page_Modern React and NodeJS Development (h_2e3419/a_Get started now'))

WebUI.verifyElementVisible(findTestObject('Object Repository/Page_Modern React and NodeJS Development (h_2e3419/h1_Sign up to enroll'))
